...
let _require = require(`gatsby/dist/redux/actions`),
...
function queueImageResizing({
  ...
  fs.ensureDirSync(dirPath); // Create function to call when the image is finished.
...
function _generateBase() {
  _generateBase = (0, _asyncToGenerator2.default)(function* ({
    ...
    const _ref4 = yield pipeline.toBufferAsync(),
          buffer = _ref4[0],
          info = _ref4[1];
...
function () {
  var _ref2 = (0, _asyncToGenerator2.default)(function* (_ref3) {
    let cache = _ref3.cache,
        arg = (0, _objectWithoutPropertiesLoose2.default)(_ref3, ["cache"]);
  ...
  return function cachifiedBase64(_x3) {
...
function notMemoizedtraceSVG(_x7) {
