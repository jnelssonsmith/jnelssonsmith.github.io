...
const isUnitlessOrPixelNumber = n => n && (isUnitlessNumber(n) || isPixelNumber(n)); // Aspect ratio can only be determined if both width and height are unitless or
  ...
  visit(markdownAST, `html`, node => {
    ...
    if (iframe.length) {
      ...
      if (acceptedDimensions(width, height)) {
        ...
        node.type = `unknown`; // Also apparently, for html node types, you have to delete the value
